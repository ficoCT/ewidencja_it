            ...
            <Alert key={computer.id} variant='primary'>
                ...
                <div className="buttons">
                    <Button variant="warning"
                            size="sm"
                            className="me-1"
                            onClick={handleEditButtonClick}>Edytuj</Button>
                    <Button variant="danger"
                            size="sm"
                            className="me-1"
                            onClick={handleDeleteButtonClick}>Usuń</Button>
                    <Button variant="info"
                            size="sm"
                            className="me-1"
                            onClick={handlePrintingButtonClick}>Podgląd formularza</Button>
                    <Assign computerId={computer.id}
                            users={users}
                            assign={assign}
                            refresh={refresh}
                    />
        ...
        <Alert key={computer.id} variant='primary'>
            ...
            <div className="buttons">
                ...
                <Button variant="success"
                        size="sm"
                        className="me-1"
                        onClick={assignUserToComputer}>Przypisz użytkownika</Button>
            </div>
        </Alert>
